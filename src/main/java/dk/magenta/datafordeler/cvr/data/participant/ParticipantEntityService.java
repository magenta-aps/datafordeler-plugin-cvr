...
@RestController
@RequestMapping("/cvr/participant/0/rest")
public class ParticipantEntityService extends FapiService<ParticipantEntity, ParticipantQuery> {
    ...
    protected void applyAreaRestrictionsToQuery(ParticipantQuery query, DafoUserDetails user) throws InvalidClientInputException {
